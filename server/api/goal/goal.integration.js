...
describe('Goal API:', function() {
  ...
  describe('POST /api/goals', function() {
    ...
    it('should respond with the newly created goal', function() {
      expect(newGoal.name).to.equal('New Goal');
      expect(newGoal.info).to.equal('This is the brand new goal!!!');
    });
  ...
  describe('GET /api/goals/:id', function() {
    ...
    it('should respond with the requested goal', function() {
      expect(goal.name).to.equal('New Goal');
      expect(goal.info).to.equal('This is the brand new goal!!!');
    });
  ...
  describe('PUT /api/goals/:id', function() {
    ...
    it('should respond with the updated goal', function() {
      expect(updatedGoal.name).to.equal('Updated Goal');
      expect(updatedGoal.info).to.equal('This is the updated goal!!!');
    });
